...
# static fields
.field public static final ARG_FROM_SETTINGS:Ljava/lang/String; = "fromSettings"
...
.method private findPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    :try_start_0
    iget-object v5, p0, Lcom/android/settings/notification/NotificationSettingsBase;->mIPm:Landroid/content/pm/IPackageManager;

    const v6, 0x400040

    iget v7, p0, Lcom/android/settings/notification/NotificationSettingsBase;->mUid:I

    invoke-static {v7}, Landroid/os/UserHandle;->getUserId(I)I

    move-result v7

    invoke-interface {v5, p1, v6, v7}, Landroid/content/pm/IPackageManager;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    const-string v7, "NotifiSettingsBase"
...
.method private getAlertingIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1}, Lcom/android/settings/Utils;->getColorAccent(Landroid/content/Context;)Landroid/content/res/ColorStateList;
...
.method private loadChannel()V
    ...
    invoke-virtual {v1, v2, v4, v3}, Lcom/android/settings/notification/NotificationBackend;->getChannel(Ljava/lang/String;ILjava/lang/String;)Landroid/app/NotificationChannel;
...
.method private loadChannelGroup()V
    ...
    invoke-virtual {v0, v2, v3, v1}, Lcom/android/settings/notification/NotificationBackend;->getChannel(Ljava/lang/String;ILjava/lang/String;)Landroid/app/NotificationChannel;
...
.method private toggleBehaviorIconState(Landroid/graphics/drawable/Drawable;Z)V
    ...
    invoke-virtual {v1}, Landroid/graphics/drawable/GradientDrawable;->clearColorFilter()V
...
.method protected collectConfigActivities()V
    ...
    sget-boolean v6, Lcom/android/settings/notification/NotificationSettingsBase;->DEBUG:Z
    ...
    iput-object v7, v6, Lcom/android/settings/notification/NotificationBackend$AppRow;->settingsIntent:Landroid/content/Intent;

    iget-object v6, p0, Lcom/android/settings/notification/NotificationSettingsBase;->mChannel:Landroid/app/NotificationChannel;
    ...
    :cond_4
    iget-object v6, p0, Lcom/android/settings/notification/NotificationSettingsBase;->mChannelGroup:Landroid/app/NotificationChannelGroup;
...
.method public synthetic lambda$populateSingleChannelPrefs$0$NotificationSettingsBase(Landroid/app/NotificationChannel;Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    :goto_0
    invoke-virtual {p1, v3}, Landroid/app/NotificationChannel;->setImportance(I)V

    const/4 v4, 0x4

    invoke-virtual {p1, v4}, Landroid/app/NotificationChannel;->lockFields(I)V

    move-object v4, p2

    check-cast v4, Lcom/android/settings/widget/MasterSwitchPreference;

    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lcom/android/settings/widget/MasterSwitchPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v4, v1}, Lcom/android/settings/widget/MasterSwitchPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    :cond_1
    invoke-virtual {v4}, Lcom/android/settings/widget/MasterSwitchPreference;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-direct {p0, v1, v2}, Lcom/android/settings/notification/NotificationSettingsBase;->toggleBehaviorIconState(Landroid/graphics/drawable/Drawable;Z)V
    ...
    invoke-virtual {v1, v2, v6, p1}, Lcom/android/settings/notification/NotificationBackend;->updateChannel(Ljava/lang/String;ILandroid/app/NotificationChannel;)V
...
.method public onAttach(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/NotificationSettingsBase;->mRm:Landroid/app/role/RoleManager;
    ...
    iput-object v1, p0, Lcom/android/settings/notification/NotificationSettingsBase;->mIPm:Landroid/content/pm/IPackageManager;

    iget-object v1, p0, Lcom/android/settings/notification/NotificationSettingsBase;->mArgs:Landroid/os/Bundle;
...
.method protected populateSingleChannelPrefs(Landroidx/preference/PreferenceGroup;Landroid/app/NotificationChannel;Z)Landroidx/preference/Preference;
    ...
    :cond_1
    invoke-virtual {v0, v4}, Lcom/android/settings/widget/MasterSwitchPreference;->setIconSize(I)V
    ...
    iget-object v4, v4, Lcom/android/settings/notification/NotificationBackend$AppRow;->sentByChannel:Ljava/util/Map;
    ...
    invoke-static {v1, v4, v3}, Lcom/android/settings/notification/NotificationBackend;->getSentSummary(Landroid/content/Context;Lcom/android/settings/notification/NotificationBackend$NotificationsSentState;Z)Ljava/lang/CharSequence;
    ...
    new-instance v2, Lcom/android/settings/notification/-$$Lambda$NotificationSettingsBase$krsRZLoKmsJKNXanTlSV0s9r-5U;

    invoke-direct {v2, p0, p2}, Lcom/android/settings/notification/-$$Lambda$NotificationSettingsBase$krsRZLoKmsJKNXanTlSV0s9r-5U;-><init>(Lcom/android/settings/notification/NotificationSettingsBase;Landroid/app/NotificationChannel;)V

    invoke-virtual {v0, v2}, Lcom/android/settings/widget/MasterSwitchPreference;->setOnPreferenceChangeListener(Landroidx/preference/Preference$OnPreferenceChangeListener;)V
...
.method protected setVisible(Landroidx/preference/Preference;Z)V
    .locals 1

    invoke-virtual {p0}, Lcom/android/settings/notification/NotificationSettingsBase;->getPreferenceScreen()Landroidx/preference/PreferenceScreen;

    move-result-object v0

    invoke-virtual {p0, v0, p1, p2}, Lcom/android/settings/notification/NotificationSettingsBase;->setVisible(Landroidx/preference/PreferenceGroup;Landroidx/preference/Preference;Z)V
